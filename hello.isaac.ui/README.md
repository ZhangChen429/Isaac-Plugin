...
- Put selected Mesh prims into a new `group_N` Xform under their nearest common Xform parent, then move the meshes into an inner Xform whose editable default name is `body`, while preserving world transforms.
